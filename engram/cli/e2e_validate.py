...
Skip ingestion (retrieval-only)::
  ...
  engram-e2e --skip-seed --user-id <existing_user_id>

or::

  E2E_USER_ID=<id> engram-e2e --skip-seed
...
def main(argv: list[str] | None = None) -> int:
    """Console entry point for ``engram-e2e`` and ``python -m engram.cli.e2e_validate``."""
    import traceback
