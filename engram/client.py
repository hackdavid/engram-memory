...
from engram.exceptions import HasRelationshipsError
...
from engram.graph.sanitise import validate_user_id
...
class AsyncMemoryClient:
    ...
    def __init__(self, config: Config) -> None:
        ...
        if config.embedding_provider == "local":
            from engram.embeddings.sentence_transformer import LocalEmbedding
            self._embedder = LocalEmbedding(model_name=config.embedding_model)
        else:
            from engram.embeddings.openai_embedding import OpenAIEmbedding
